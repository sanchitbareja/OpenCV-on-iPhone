...
#define SHKMyAppName			@"Share Homework"
#define SHKMyAppURL				@"http://www.flypn.com"
...
#define SHKFacebookKey				@"170175376387002"
#define SHKFacebookSecret			@"6268fff967e5adb663a035258eea68c8"
 ...
 */
#define SHKTwitterConsumerKey		@"oZPtGdhSL8QwaZZUVboCug"
#define SHKTwitterSecret			@"Yolt1aB9CcMhzdPCIuX1oF3hlUmalgkZcYmN7DtKj4"
#define SHKTwitterCallbackUrl		@"http://www.flypn.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"sanchitbareja"
#define SHKBitLyKey					@"R_9dccc68c4d08c6532d80196e1ccbb535"
