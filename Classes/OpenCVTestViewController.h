...
@interface OpenCVTestViewController : UIViewController <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
    ...
    IBOutlet UIBarButtonItem *process;
    IBOutlet UILabel *instructions;
    IBOutlet UISegmentedControl *processingtype;
...
@property (nonatomic, retain) UIBarButtonItem *process;
@property (nonatomic, retain) UILabel *instructions;
@property (nonatomic, retain) UISegmentedControl *processingtype;
@end